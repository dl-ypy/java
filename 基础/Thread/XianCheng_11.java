...
若m2加synchronized:
main -> t.start()开启子线程 -> 主线程继续执行，x.m2()，synchronized对当前对象加锁，只有执行完当前方法，子线程才能执行同样加锁的m1,设a=2000,执行完m2方法后，再执行子线程 -> 子线程执行m1方法，设a=1000,sleep(5000)，执行主线程，输出1000，再执行子线程输出a=1000
*/